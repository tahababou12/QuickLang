...
###########################  detecting if correct answer from answers table########################### 
$score=mysqli_real_escape_string($cnx,$_POST['score']);
$id_question=mysqli_real_escape_string($cnx,$_POST['qst']);
//// first detecting if correct answer from answers table////
...
$new_list=$question_list.$aff_next['id'].',';
 ...
 $question_div = '
  <img src="img/game/'. $next_question.'" class="card-img-top img-fluid" >';
...
<a href="pictures"  class="btn btn-primary">Retry</a>
