<?php
// UPDATE complete word specific answer in database
...
if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
	...
	if($update){
		header('location: answer-complete.php?msg=rus&id_question='.$_REQUEST['id_question'].'');
		exit;
	}else{
		header('location: answer-complete.php?msg=rnu&id_question='.$_REQUEST['id_question'].'');
		exit;
	}
}
?>
   	...
   	<div class="container">
		...
		<div class="card">
			<div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Editer réponse pour  <strong>
				...
				</strong></strong> <a href="answer-complete.php?id_question=<?php echo $_REQUEST['id_question']; ?>" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i> Voir Réponses</a></div>
			<div class="card-body">
