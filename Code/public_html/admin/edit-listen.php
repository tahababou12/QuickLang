<?php
// UPDATE Listen game specific question in database
...
if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
	...
	if($update){
		header('location: listen.php?msg=rus&editId='.$_REQUEST['editId'].'');
		exit;
	}else{
		header('location: listen.php?msg=rnu&editId='.$_REQUEST['editId'].'');
		exit;
	}
}
?>
   	...
   	<div class="container">
		...
		<div class="card">
			<div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Editer Question  <strong>
				...
				?>
				</strong></strong> <a href="listen.php?id_question=<?php echo $_REQUEST['editId']; ?>" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i> Voir Questions</a></div>
			<div class="card-body">
