<?php 
// UPDATE Writing game specific question in database
...
if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
	...
	if($update){
		header('location: edit-writing.php?msg=rus&editId='.$_REQUEST['editId'].'');
		exit;
	}else{
		header('location: edit-writing.php?msg=rnu&editId='.$_REQUEST['editId'].'');
		exit;
	}
}
?>
...
<body>
   	...
   	<div class="container">
		...
		<div class="card">
			<div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Edit Question <strong>
				<?php 
				...
				<div class="col-sm-6">
					...
					<form method="post">
						...
						<div class="form-group">
							...
							<button type="submit" name="submit" value="submit" id="submit" class="btn btn-primary"><i class="fa fa-fw fa-plus-circle"></i> Edit Question</button>
