<?php 
// UPDATE Writing game specific answer in database
...
if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
	...
	if($update){
		header('location: answer-writing.php?msg=rus&id_question='.$_REQUEST['id_question'].'');
		exit;
	}else{
		header('location: answer-writing.php?msg=rnu&id_question='.$_REQUEST['id_question'].'');
		exit;
	}
}
?>
