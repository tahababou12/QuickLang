<?php
// UPDATE pictures  game specific answer in database
...
if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
	...
	if($update){
		header('location: answer-pics.php?msg=rus&id_question='.$_REQUEST['id_question'].'');
		exit;
	}else{
		header('location: answer-pics.php?msg=rnu&id_question='.$_REQUEST['id_question'].'');
		exit;
	}
}
?>
   	...
   	<div class="container">
		...
		<div class="card">
			<div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Editer réponse pour  <strong>
				...
				?>
				<img src="../img/game/<?php echo $qst['question_text']; ?>" >
				</strong></strong> <a href="answer-writing.php?id_question=<?php echo $_REQUEST['id_question']; ?>" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i> Voir Réponses</a></div>
			<div class="card-body">
