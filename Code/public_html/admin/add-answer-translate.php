<?php 
 // add possible answers in database for translation game quizz ///
...
if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
	...
	if($answer_text==""){
		...
		exit;
			...
			if($insert){
				header('location:add-answer-translate.php?msg=ras&id_question='.$id_question.'');
				exit;
			}else{
				header('location:add-answer-translate.php?msg=rna&id_question='.$id_question.'');
				exit;
			}
   	...
   	<div class="container">
		...
		<div class="card">
			...
			<div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Ajout  Reponse pour : <strong>
				...
				?>
				</strong></strong> <a href="answer-translate.php?id_question=<?php echo $_REQUEST['id_question']; ?>" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i> Liste Réponses</a></div>
