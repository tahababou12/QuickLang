...
<div class="veen">
			<div class="login-btn splits">
				...
				if (isset($_SESSION['error'])) {
					...
					break;
						case 2:
					$message='<i class="error">Invalid password or email address</i></br></br>';
					$forgot='<u class="reset"><a href="reset">Recover password</a></u></br></br>';
					break;
						case 3:
					$message='<i class="error">The Password recovery email has been sent to your email address. PLease check your inbox.</i></br></br>';	
					$forgot='';
							break;
					}
					###################### end errors test#####################################
