...
<?php include("inc/header.php"); ?>
				...
				<div class="row">
				 <div class="col-md-4 col-sm-offset-1">
                        ...
                        <div class="ribbons">
                            ...
                            <div class="ribbon ribbon-blue"><span>Welcome  <?php echo $_SESSION['firstname']; ?> to Translation Game
		</span>     </div>   
                            <!--/ Ribbons -->
                        </div>
						 ...
						 <div id="timebar"></div>
							...
							<form action="#" method="post" id="commentForm" class="ajax_form">
								...
								#################### games index : 1-wiriting 2-pics and words 3-COMPLETE THE SENTENCE 4-PAIR GAME 5-LISTEN and WRITE 6-translation  ####################
									...
									$sql_qst="SELECT * FROM questions WHERE id_game=6 ORDER BY RAND() LIMIT 1";
    ...
    <?php  	#####################hidden fields showing actual question database ID and actual score  ##################### ?>
  ...
  <input type="hidden" value="<?php echo $id_question; ?>" id="qst"/>
       <?php  	#####################Printing Question variable $question into this block ##################### ?>
  <div class="add-comment-title" id="qst_txt"><h3><?php echo $question; ?></h3>  </div>
								...
								<div class="form-inner">
                                    <div class="field_text">
                                        <label for="name" class="label_title">Write the correct translation:</label>
...
var maxWidth = 300;
    ...
    $(function() {
        ...
        $.ajax({
            type: 'POST',
            url: 'services/check_answer6.php', 
            dataType: "json",
